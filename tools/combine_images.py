...
if __name__ == '__main__':
    ...
    parser.add_argument("--input_dir", required=True, 
                            help="path to folder containing font images")
    ...
    # combine
    parser.add_argument("--b_dir", type=str, help="path to folder containing target skeleron images for combine operation")
    ...
    # trg_skl_head, _ = os.path.split(args.b_dir)
